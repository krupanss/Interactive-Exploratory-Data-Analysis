...
ui = dashboardPage(title = "InteractiveEDA",
  ...
  dashboardHeader(title = div(img(src="Title.png",height=50,width=150,align = "left"), 
                              "IEDA"),
                  tags$li(tags$script(HTML("<script src=\"//platform.linkedin.com/in.js\" 
                          type=\"text/javascript\"> lang: en_US</script> <script type=\"IN/Share\" 
                          data-url=\"https://sskdatalab.shinyapps.io/interactive_data_exploratory_analysis/\" 
